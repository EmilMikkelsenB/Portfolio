...
export default function Bento() {
    ...
    return (
        <>
            ...
            <div className='container mx-auto mt-[20vh] md:p-4 p-0 text-white md:w-[60vw]  md:text-xl text-xs align-middle min-w-[0px]'>

                <div className='grid md:grid-cols-3 gap-x-2 gap-y-3 md:grid-flow-row-dense md:m-0 m-2'>
                    <Card ><span className=''>Hi&nbsp;Im&nbsp;Emil!&nbsp;I&nbsp;am&nbsp;a&nbsp;fullstack developer</span></Card>
                    ...
                    <div className='row-span-1 min-h-[50px] md:row-span-1'><Card>Im&nbsp;proficient&nbsp;at: <span id='skills'></span></Card></div>
